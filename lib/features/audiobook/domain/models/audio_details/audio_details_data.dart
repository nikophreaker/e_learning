...
class AudioDetailsData {
  ...
  AudioDetailsData.fromJson(dynamic json) {
    _id = json['_id'];
    _artist = json['artist'];
  ...
  factory AudioDetailsData.fromMediaItem(MediaItem mediaItem) {
  ...
  MediaItem toMediaItem() => MediaItem(
        ...
        artist: artist,
        title: title ?? "",
        artUri: Uri.parse(thumbnail?[0].url ?? ""),
